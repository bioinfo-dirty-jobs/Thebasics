...
[IGV]: http://software.broadinstitute.org/software/igv/ "IGV"
...
Proably you can use this tool many times if you work with ngs data.
...
# SETUP
We use a conda enviroment for install igv

	conda create -n test8
    conda activate test8
    conda install igv

Download the file for this tutorial from this linf 
...
* [HCC1143.normal.21.19M-20M.bam](https://www.dropbox.com/sh/bdqc7qv1j8qumps/AACJLADT_aelMbgrz9xgI7oSa?dl=0)
...
*Read this [IGV_talk](http://research.stowers.org/mcm/cshl_programming_2015/IGV.pdf)

## Contributors/acknowledgements
This tutorial was develop based on tutorial of Malachi Griffith, Sorana Morrissy, Jim Robinson, Ben Ainscough, Jason Walker, Obi Griffith
